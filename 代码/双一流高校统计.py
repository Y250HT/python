# 双一流高校统计
# 字典 d 中存储了我国 42 所双一流高校及所在省份的对应关系，请以这个列表为数
# 据变量，完善 Python 代码，统计各省份学校的数量。
...
counts = {}  #定义一个空字典 用于存放学校 以地方为key 学校为value
for place in d.values():   #遍历字典d中的values值即地点
    counts[place] = counts.get(place,0) + 1
    #get()方法 dict.get(key,default=0) 此处设置默认值为了巧妙统计学校数量 表示如果键不在字典中返回默认值0
